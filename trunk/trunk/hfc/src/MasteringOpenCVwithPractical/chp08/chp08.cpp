...
/*
 * remove arguments:   VideoCapture &videoCapture,
 */
void recognizeAndTrainUsingWebcam( CascadeClassifier &faceCascade, CascadeClassifier &eyeCascade1, CascadeClassifier &eyeCascade2)
{
    ...
    //while (true) {
		...
		*/
    	...
    	/*
    	Mat m(img,true);
    	Mat cameraFrame=Mat(m.size(),CV_8UC3);
    	IplImage temp4cameraFrame=cameraFrame.operator IplImage();
    	*/
    	//Mat gray;
        ...
        //IplImage temp_ipl_img = displayedFrame;
        //cvShowImage(windowName,&temp_ipl_img );

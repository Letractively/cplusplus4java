...
#ifndef PATCH_MODEL_EXE_H_
#define PATCH_MODEL_EXE_H_
...
/*
 *learn a patch_model object from training data
 *arguments:outdir/annotations.yaml  outdir/train_model_file outdir/patch_train_model_file
 */
int train_patch_model_main(int argc,char** argv){
	//parse cmdline input

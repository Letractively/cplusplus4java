...
//step 2:detect mouth
	Rect third3face=Rect(0,2*faceImg.rows/3,faceImg.cols,1*faceImg.rows/3  );
	Mat mouth4third=faceImg( third3face );
	alert_win( mouth4third );
	Rect mouthRect;
	int scaledWidth4mouth=mouth4third.cols;
	detectLargestObject( mouth4third,mouthCascade,mouthRect,scaledWidth4mouth );
	alert_win( mouth4third(mouthRect) );
